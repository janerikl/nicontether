...
// Small, UI-independent store for recently opened/saved Photonloom project
// (.ploom) files. Backed by QSettings (the existing "Photonloom" org/app
// scope). The list holds absolute file paths, newest first, de-duplicated by
// path and capped at kMaxRecent.
